...
class DensityVAE(object):
    ...
    def __init__(self, input_dim=None, verbose=False):
        self.model = ModelVAE(input_dim=input_dim, verbose=verbose)
        self.manifold = None
    ...
    def sample_radius(self, x_exp, r=None, n_samples=1, random_state=None):
        ...
        # TODO: I am not sure if is better or not multiply the distance r by std_r.
...
class ModelVAE(object):
    ...
    def __init__(self, input_dim, nodes_dim=400, n_layers=2, latent_dim=12, cuda=True, verbose=False):
        ...
        self.model = VAE(input_dim, nodes_dim=nodes_dim, n_layers=n_layers, latent_dim=latent_dim, device=self.device).to(self.device)
...
class VAE(nn.Module):
    def __init__(self, input_dim=784, nodes_dim=400, n_layers=2, latent_dim=12, device=None):
        ...
        self.device = device
        # Encoder
        self.layers_encoder = nn.ModuleList(self.create_layers(input_dim, nodes_dim, n_layers))
